...
#include <contrib/ktx/lib/gl_funcs.h>

#include <ktx.h>
#include <contrib/ktx/lib/ktxint.h>
#include <contrib/ktx/lib/texture.h>
#include <contrib/ktx/lib/gl_format.h>      // Must come after texture.h.
#include <contrib/ktx/utils/unused.h>
                             ...
                             void* pixels, void* userdata)
{
            ...
            ))
    {
        ...
        free(unpacked);
        glerror = glGetError();
    } else if ((glerror == GL_INVALID_ENUM || glerror == GL_INVALID_VALUE)
               && (GL_COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR <= cbData->glInternalformat
                   && cbData->glInternalformat <= GL_COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR)) {
        GLenum format, internalformat, type;
        type = GL_UNSIGNED_BYTE;
        format = internalformat = GL_RGBA;
        size_t size = width*height*4;
        GLubyte* unpacked = calloc(1, size);
        int fp;
        switch (cbData->glInternalformat) {
        case GL_COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR: fp = 0; break;
        case GL_COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR: fp = 1; break;
        case GL_COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR: fp = 2; break;
        case GL_COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR: fp = 3; break;
        case GL_COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR: fp = 4; break;
        case GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR: fp = 5; break;
        case GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR: fp = 6; break;
        case GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR: fp = 7; break;
        case GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR: fp = 8; break;
        case GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR: fp = 9; break;
        case GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR: fp = 10; break;
        case GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR: fp = 11; break;
        case GL_COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR: fp = 12; break;
        case GL_COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR: fp = 13; break;
        default: assert(0); break;
        }
        if (ASTC_decompress(pixels, faceLodSize, width, height, fp,
                            unpacked, size, width*4) != 1)
        {
            assert(0);
        }
